...
namespace WorldServer.Game.Chat.Commands
{
    public class CreatureCommands : Globals
    {
        ...
        public static void Test2(string[] args, ref WorldClass session)
        {
            ...
            byte[] arr = new byte[] {   };
                  PacketWriter pp = new PacketWriter(LegacyMessage.UpdateObject);
                  byte[] guid = new byte[] { 0x01, 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0xF1 };
                  ulong k = System.BitConverter.ToUInt64(guid, 0);
                  pp.WriteUInt64(k);//guid
            pp.WriteBytes(arr,arr.Length);
            session.Send(ref pp);
