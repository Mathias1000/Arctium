...
namespace WorldServer.Game.Chat.Commands
{
    public class CreatureCommands : Globals
    {
        ...
        public static void Test2(string[] args, ref WorldClass session)
        {
            ...
            updateObject.WriteGuid(32974);
            updateObject.WriteUInt8((byte)ObjectType.Item);
            main.SetUpdateField<Int64>((int)PlayerFields.InvSlots+(2*2), 1223121);
            main.SetUpdateField<Int64>((int)ItemFields.ContainedIn,1223121);
            main.SetUpdateField<UInt64>((int)ItemFields.Owner, session.Character.Guid);
            main.WriteUpdateFields(ref updateObject);
